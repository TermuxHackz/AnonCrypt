...
const main = () => {
  ...
  console.log(
    `${banner}
	 Welcome to the menu of AnonCrypt - Choose from below!!!
	 \n\x1b[91m\tKINDLY IGNORE WARNINGS YOU MAY SEE!!\x1b[0m\n
	 \t\x1b[93m[01] Cipher a Text \x1b[0m
	 \t\x1b[93m[02] Dicipher a Text \x1b[0m
	 \t\x1b[93m[03] Show my current system [eg Windows, Linux, etc]\x1b[0m
	 \t\x1b[93m[04] Start HTTP Server and Visit Site for more Tools\x1b[0m`
  )

  switch (Number(prompt("Choose your number: "))) {

    case 1: {
      const message = prompt("Enter text to encrypt: ")
